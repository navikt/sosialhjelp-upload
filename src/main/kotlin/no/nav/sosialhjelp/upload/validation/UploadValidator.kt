...
class UploadValidator(val virusScanner: VirusScanner, val filePathFactory: FilePathFactory, val logger: Logger) {
    ...
    private fun File.checkIfPdfIsValid(): Validation? {
        return try {
            Loader
                .loadPDF(this)
                .use { document ->
