...
class DocumentRoutesTest {
    ...
    private fun createCompletedUpload(submissionId: UUID): UUID {
    ...
    @Test
    fun `returns 403 when user does not own upload`() =
        appTest {
    ...
    @Test
    fun `returns 200 when user owns upload`() =
        appTest {
